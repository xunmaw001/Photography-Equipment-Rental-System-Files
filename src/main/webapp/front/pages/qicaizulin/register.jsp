	...
	<body style="background: #EEEEEE; ">
		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="qicaileixing" name="qicaileixing" placeholder="请输入器材类型" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="zulintianshu" name="zulintianshu" placeholder="请输入租赁天数" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                                                                <div class="layui-form-item layui-form-text">
