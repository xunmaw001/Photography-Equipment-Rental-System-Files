			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.qicaibianhao" type="text" name="qicaibianhao" id="qicaibianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">器材名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.qicaimingcheng" type="text" name="qicaimingcheng" id="qicaimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">器材类型</label>
                        <div class="layui-input-block">
                            <select name="qicaileixing" id="qicaileixing" lay-filter="qicaileixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in qicaileixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.meitianjiage" type="text" name="meitianjiage" id="meitianjiage" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">商家账号：</label>
						<div class="layui-input-block">
							<input v-model="detail.shangjiazhanghao" type="text" name="shangjiazhanghao" id="shangjiazhanghao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">商家名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.shangjiamingcheng" type="text" name="shangjiamingcheng" id="shangjiamingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/qicaifenlei/qicaileixing`,'get',{},(res)=>{
					vue.qicaileixing = res.data
				});
																// 上传图片
				...
				form.on('submit(*)', function(data) {
					...
					data.jianjie = jianjie;
                        ...
                        return false
                                                            ...
                                                            if(!isIntNumer(data.meitianjiage)){
                        layer.msg('每天价格应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('qicaixinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
