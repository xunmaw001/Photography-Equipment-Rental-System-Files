				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="qicaileixing" id="qicaileixing">
							...
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="tupianUpload">
									<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">租赁规则</label>
							<div class="layui-input-block">
								<input type="text" name="zulinguize" id="zulinguize" placeholder="租赁规则" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
