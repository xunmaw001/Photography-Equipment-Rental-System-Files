	...
	<body>
		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<div class="line-container">
					<p class="line"> 器材信息展示 </p>
				</div>
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../qicaixinxi/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../qicaixinxi/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in qicaixinxiList" v-bind:key="index" v-if="item">
																																																						
						<img class="cover" :src="item.tupian?item.tupian.split(',')[0]:''">
						
																																																																																																
																														
						<h3 class="title">{{item.qicaimingcheng}}</h3>
				...
				http.request('news/list', 'get', {
					...
					if (newsList.length > 2 && newsList.length <= 8) {
						...
						console.log('rightNewsList',rightNewsList,vue.rightNewsList)
                                                                                                                                                ...
                                                                                                                                                http.request(`qicaixinxi/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.qicaixinxiList = res.data.list
				});
