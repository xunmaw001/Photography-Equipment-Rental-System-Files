	...
	<body style="background: #EEEEEE;">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="liaotianneirong" id="liaotianneirong" placeholder="聊天内容" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">发送日期</label>
							<div class="layui-input-block">
								<input type="text" name="fasongriqi" id="fasongriqi" placeholder="发送日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				form.on('select(shangjiazhanghao)', (data) => {
					console.log(data.value);
					http.request('follow/shangjia/shangjiazhanghao', 'get', {
