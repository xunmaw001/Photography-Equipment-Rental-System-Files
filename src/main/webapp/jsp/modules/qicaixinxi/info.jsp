						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																			...
																			<input id="qicaimingcheng"  v-model="ruleForm.qicaimingcheng" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="qicaileixing"  v-model="ruleForm.qicaileixing" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				...
																				<div class="col-lg-6">
																			<input id="jianjie"  v-model="ruleForm.jianjie" readonly>
																			</div>
									</div>
																																															<div class="form-group">
																			...
																			<input id="shuliang"  v-model="ruleForm.shuliang" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="meitianjiage"  v-model="ruleForm.meitianjiage" readonly>
																			</div>
									</div>
																																<div class="form-group">
																			...
																			<input id="shangjiazhanghao"  v-model="ruleForm.shangjiazhanghao" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="shangjiamingcheng"  v-model="ruleForm.shangjiamingcheng" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">详细地址</label>
																				<div class="col-lg-6">
																			<input id="xiangxidizhi"  v-model="ruleForm.xiangxidizhi" readonly>
																			</div>
									</div>
											...
											<div class="col-lg-6">
												...
												<input type="hidden" id="jianjie-input">
											</div>
										</div>
																																																			<div class="form-group">
											...
											<div class="col-lg-6">
												...
												<input type="hidden" id="zulinguize-input">
											</div>
										</div>
																																																																																																																																																																																															<!-- 表单按钮 -->
							<div class="form-group">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qicaixinxi/info/" + id,
