	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">器材信息列表</div>
								...
								<th><input type="checkbox" onclick="chooseAll()"/></th>
																											<th onclick="sort('qicaibianhao')">器材编号<i id="qicaibianhaoIcon" class="fa fa-sort"></i></th>
																																				...
																																				<th onclick="sort('jianjie')">简介<i id="jianjieIcon" class="fa fa-sort"></i></th>
																																															<th style="min-width: 100px;">租赁规则</th>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setDataRow(item){
			...
			row.appendChild(chkTd);
				  ...
				  if(item.jianjie && item.jianjie.indexOf('img') != -1){
					...
					jianjieCell.innerHTML = item.jianjie.substring(beginIndex, endIndex+1);				
				  }else{
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qicaixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'qicaixinxi/page';
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"qicaixinxi");
