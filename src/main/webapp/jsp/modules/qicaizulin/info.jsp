						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																			...
																			<input id="shuliang"  v-model="ruleForm.shuliang" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="zulintianshu"  v-model="ruleForm.zulintianshu" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">总金额</label>
																				<div class="col-lg-6">
																			<input id="zongjine"  v-model="ruleForm.zongjine" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">租赁日期</label>
																				<div class="col-lg-6">
																			<input id="zulinriqi"  v-model="ruleForm.zulinriqi" readonly>
																			</div>
									</div>
																																<div class="form-group">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qicaizulin/info/" + id,
