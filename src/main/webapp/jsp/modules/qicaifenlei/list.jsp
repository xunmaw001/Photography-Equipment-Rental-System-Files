		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">器材分类</a>
	        </div>
	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">器材分类列表</div>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qicaifenlei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'qicaifenlei/page';
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"qicaifenlei");
