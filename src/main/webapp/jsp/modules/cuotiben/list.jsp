...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<!-- Page heading -->
			<div class="page-head">
				<h2 class="pull-left">错题本管理</h2>

				<!-- Breadcrumb -->
				<div class="bread-crumb pull-right">
					<a href="index.html"><i class="icon-home"></i> 主页</a>
					<!-- Divider -->
					<span class="divider">/</span> <a href="#" class="bread-current">错题本</a>
				</div>
									...
									<div class="widget-icons pull-right">
										<form class="navbar-form navbar-left" id="searchForm"
											...
											<div class="form-group" id="form-item-group">
												<label>试卷</label> <input name="papername" placeholder="试卷">
												<label>试题</label> <input name="questionname" placeholder="试题">
											</div>
										</form>
										...
										<thead>
											<tr>
												...
												<th onclick="sort('analysis')">试题分析<i
													id="analysisIcon" class="fa fa-sort"></i></th>
