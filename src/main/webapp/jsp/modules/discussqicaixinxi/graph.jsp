  ...
  <body>
	...
	<div class="content">
		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <!-- Page heading -->
	      <div class="page-head">
	        <h2 class="pull-left">器材信息评论表统计</h2>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
	 ...
	 <script type="text/javascript">
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/discussqicaixinxi/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/discussqicaixinxi/"+colName,
             	data:{	tableName: "discussqicaixinxi",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
