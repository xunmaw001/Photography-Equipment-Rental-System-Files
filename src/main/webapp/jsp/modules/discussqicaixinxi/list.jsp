  ...
  <body>
	...
	<div class="content">
		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <!-- Page heading -->
	      <div class="page-head">
	        <h2 class="pull-left">器材信息评论表管理</h2>
	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">器材信息评论表列表</div>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
        ...
        function getDataList() {
			http("discussqicaixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussqicaixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'discussqicaixinxi/page';
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"discussqicaixinxi");
