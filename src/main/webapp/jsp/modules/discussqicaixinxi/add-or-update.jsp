...
<html lang="zh-cn">
  ...
  <body>
	    ...
	    <%@ include file="../../static/sidebar.jsp"%>
	  	<div class="mainbar">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">器材信息评论表</a>
	        </div>
	                  ...
	                  <div class="padd">
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input id="updateId" name="id" type="hidden">
										...
										<label class="control-label col-lg-3">关联表id</label>
										<div class="col-lg-6">
											<input id="refid" name="refid" placeholder="关联表id">
										</div>
									</div>	
											<div class="form-group">
										<label class="control-label col-lg-3">评论内容</label>
										<div class="col-lg-6">
											<input id="content" name="content" placeholder="评论内容">
										</div>
									</div>	
											<div class="form-group">
	...
	<script type="text/javascript">
		...
		var tableName = "discussqicaixinxi";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					http("discussqicaixinxi/info/" + id,"GET",{},(res)=>{
						if(res.code == 0){
		...
		function submit() {
				...
				httpJson("discussqicaixinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
																																																			if(flag){
							alert(successMes);
						}
		...
		function calculationSE(colName){
			//单列求和接口
			http("discussqicaixinxi"+colName,"GET",{
