	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">客服聊天表列表</div>
	                    ...
	                    <table class="table table-striped table-bordered table-hover">
	                      <thead>
	                        <tr>
								...
								<th style="min-width: 100px;">新消息</th>
								<th onclick="sort('isreply')">状态<i id="isreplyIcon" class="fa fa-sort"></i></th>					
                                <th>操作</th>
	                        </tr>
	                      </thead>
	                      <tbody id="tbMain">
