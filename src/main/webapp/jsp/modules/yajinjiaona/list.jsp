  ...
  <body>
	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">押金缴纳列表</div>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setDataRow(item){
            ...
            crossBtn1.innerHTML = "扣押金"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-xs btn-primary");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"kouchuyajin\")");
			if(crossBtnControl('扣押金') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yajinjiaona/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'yajinjiaona/page';
		...
		function sh(){
			...
			httpJson("yajinjiaona/update","POST",data,(res)=>{
				if(res.code == 0){
					$("#closeDialog").click();
					alert("提交成功");
			...
			window.sessionStorage.setItem('crossTableName',"yajinjiaona");
        ...
        function pay(id){
            window.sessionStorage.setItem('id',id);
			window.sessionStorage.setItem('tableName',"yajinjiaona");
