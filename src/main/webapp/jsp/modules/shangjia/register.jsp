	              ...
	              <div class="widget-content">
	                <div class="padd">
	                  ...
	                  <form id="registerForm" class="form-horizontal" action="" method="post">
								...
								<div class="col-lg-9">
									<input type="text" name="shangjiazhanghao" class="form-control" placeholder="商家账号">
								</div>
								</div>
																			  									<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="text" name="shangjiamingcheng" class="form-control" placeholder="商家名称">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">负责人姓名</label>
								<div class="col-lg-9">
									<input type="text" name="fuzerenxingming" class="form-control" placeholder="负责人姓名">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">联系电话</label>
								<div class="col-lg-9">
									<input type="text" name="lianxidianhua" class="form-control" placeholder="联系电话">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">详细地址</label>
								<div class="col-lg-9">
									<input type="text" name="xiangxidizhi" class="form-control" placeholder="详细地址">
								</div>
								</div>
