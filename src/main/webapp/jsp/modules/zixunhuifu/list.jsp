		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">咨询回复</a>
	        </div>
	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">咨询回复列表</div>
	                    ...
	                    <a href="#" class="wclose"><i class="icon-remove"></i></a>-->
						  <form class="navbar-form navbar-left" id="searchForm" name="searchForm" role="search" style="margin: 3px 0 3px 0; white-space: nowrap;" onsubmit="saveSearchForm()">
							  <div class="form-group" id="form-item-group">
								 																			<label>用户名</label>
																					<input name="yonghuming" placeholder="用户名">
																			                                 									                                 									                                 									                                 									                                 							  </div>
						  </form>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zixunhuifu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'zixunhuifu/page';
		...
		function saveSearchForm() {
			searchForm = { key: ""};
			pageIndex = 1;
																		var yonghuming = document.forms["searchForm"]["yonghuming"].value;
						if(yonghuming != null && yonghuming.trim() != ""){
							searchForm.yonghuming = "%" + yonghuming + "%"
						}
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"zixunhuifu");
