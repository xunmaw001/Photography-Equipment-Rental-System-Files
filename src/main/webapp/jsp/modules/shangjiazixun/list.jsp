		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">商家咨询</a>
	        </div>
	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">商家咨询列表</div>
	                    ...
	                    <a href="#" class="wclose"><i class="icon-remove"></i></a>-->
						  <form class="navbar-form navbar-left" id="searchForm" name="searchForm" role="search" style="margin: 3px 0 3px 0; white-space: nowrap;" onsubmit="saveSearchForm()">
							  <div class="form-group" id="form-item-group">
								 																			<label>商家账号</label>
																					<input name="shangjiazhanghao" placeholder="商家账号">
																			                                 									                                 									                                 									                                 									                                 									                                 							  </div>
						  </form>
	                        ...
	                        <tr>
								<th><input type="checkbox" onclick="chooseAll()"/></th>
																											<th onclick="sort('shangjiazhanghao')">商家账号<i id="shangjiazhanghaoIcon" class="fa fa-sort"></i></th>
																																				...
																																				<th onclick="sort('fasongriqi')">发送日期<i id="fasongriqiIcon" class="fa fa-sort"></i></th>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setDataRow(item){
			...
			row.appendChild(chkTd);
				  	...
				  	liaotianneirongCell.innerHTML = item.liaotianneirong;
            				...
            				var fasongriqiCell  = document.createElement('td');

												  fasongriqiCell.innerHTML = item.fasongriqi; 
				  
                
									row.appendChild(fasongriqiCell);
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"zixunhuifu\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangjiazixun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'shangjiazixun/page';
		...
		function saveSearchForm() {
			searchForm = { key: ""};
			pageIndex = 1;
																		var shangjiazhanghao = document.forms["searchForm"]["shangjiazhanghao"].value;
						if(shangjiazhanghao != null && shangjiazhanghao.trim() != ""){
							searchForm.shangjiazhanghao = "%" + shangjiazhanghao + "%"
						}
		...
		function datePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																	...
																																	$(function() { 
						$('#fasongriqi_start').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
					$(function() { 
						$('#fasongriqi_end').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
		...
		function getSum(colName){
			http("shangjiazixun"+colName,"GET",{
			...
			window.sessionStorage.setItem('crossTableName',"shangjiazixun");
