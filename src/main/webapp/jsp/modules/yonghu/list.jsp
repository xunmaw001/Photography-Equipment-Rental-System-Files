		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">用户</a>
	        </div>
								...
								<th><input type="checkbox" onclick="chooseAll()"/></th>
																											<th onclick="sort('yonghuming')">用户名<i id="yonghumingIcon" class="fa fa-sort"></i></th>
																																				...
																																				<th onclick="sort('xingbie')">性别<i id="xingbieIcon" class="fa fa-sort"></i></th>
																																															<th style="min-width: 100px;">头像</th>
		...
		function setDataRow(item){
			...
			row.appendChild(chkTd);
            				...
            				var touxiangCell  = document.createElement('td');
								                  ...
								                  var touxiangCellImg = document.createElement('img');
				  touxiangCellImg.setAttribute('src',item.touxiang);
				  touxiangCellImg.setAttribute('height',100);
				  touxiangCellImg.setAttribute('width',100);
				  touxiangCell.appendChild(touxiangCellImg);
