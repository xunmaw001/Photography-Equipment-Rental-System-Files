  ...
  <body>
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input id="updateId" name="id" type="hidden">
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
										<label class="control-label col-lg-3">提醒内容</label>
										<div class="col-lg-6">
											<textarea id="tixingneirong" name="tixingneirong" class="form-control" rows="3" placeholder="提醒内容"></textarea>
										</div>
									</div>
											<div class="form-group">
										<label class="control-label col-lg-3">提醒日期</label>
										<div class="col-lg-6">	
											<div id="tixingriqi" class="input-append">
												<input id="tixingriqi-input" name="tixingriqi" data-format="yyyy-MM-dd" type="text" class="form-control dtpicker" style="max-width: 95px;">
												<span class="add-on">
	...
	<script type="text/javascript">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					http("guihaitixing/info/" + id,"GET",{},(res)=>{
						if(res.code == 0){
		...
		function submit() {
				...
				httpJson("guihaitixing/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
																																																																																																							if(flag){
							alert(successMes);
						}
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#qicaibianhao").val(ruleForm.qicaibianhao);	
																...
																$("#tixingneirong-input").val(ruleForm.tixingneirong);
																$("#tixingriqi-input").val(ruleForm.tixingriqi);
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.tixingneirong != null && res.data.tixingneirong != ''){

															$("#tixingneirong-input").val(res.data.tixingneirong);
													}
												if(res.data != null && res.data != '' && res.data.tixingriqi != null && res.data.tixingriqi != ''){

															$("#tixingriqi-input").val(res.data.tixingriqi);
								$('#tixingriqiFileName').val(res.data.tixingriqi)
													}
