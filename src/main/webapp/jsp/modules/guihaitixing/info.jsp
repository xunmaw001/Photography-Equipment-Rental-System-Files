	                  ...
	                  <div class="padd">
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																				...
																				<div class="col-lg-6">
																			<input id="qicaibianhao"  v-model="ruleForm.qicaibianhao" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">器材名称</label>
																				<div class="col-lg-6">
																			<input id="qicaimingcheng"  v-model="ruleForm.qicaimingcheng" readonly>
																			</div>
									</div>
																																<div class="form-group">
																			...
																			<input id="xingming"  v-model="ruleForm.xingming" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="tixingriqi"  v-model="ruleForm.tixingriqi" readonly>
																			</div>
									</div>
																																<div class="form-group">
											...
											<div class="col-lg-6">
												...
												<script id="tixingneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var tixingneirongUe = UE.getEditor('tixingneirongEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="tixingneirong-input">
											</div>
										</div>
																																																																																															<!-- 表单按钮 -->
							<div class="form-group">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "guihaitixing/info/" + id,
			...
			methods: { }
				...
				// 填充富文本框
		  		function setContent(){
				  									  									  									  									  											if(ruleForm.tixingneirong != null && ruleForm.tixingneirong != 'null' && ruleForm.tixingneirong != ''){
							var tixingneirongMes = '' + ruleForm.tixingneirong;
							var tixingneirongUeditor = UE.getEditor('tixingneirongEditor');
							tixingneirongUeditor.ready(function() {
								tixingneirongUeditor.setContent(tixingneirongMes);
								tixingneirongUeditor.setDisabled('fullscreen');
							});
						}
									  									  									  				}  
