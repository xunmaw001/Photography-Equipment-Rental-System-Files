...
<body>
						...
						<div class="col-md-12">
							...
							<div class="widget">
								...
								<div class="widget-head">
									<div class="pull-left">已支付订单列表</div>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item) {
			...
			fahuoBtn.setAttribute('class', 'btn btn-xs btn-warning 修改');
			var fahuoBtnAttri = 'fahuo(' + item.id + ')';
			fahuoBtn.setAttribute('onclick', fahuoBtnAttri);
			var editIcon = document.createElement('i');
			editIcon.setAttribute('class', 'icon-edit');
			fahuoBtn.appendChild(editIcon);
