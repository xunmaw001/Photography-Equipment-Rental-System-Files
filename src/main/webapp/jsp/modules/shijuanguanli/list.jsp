...
<body>
						...
						<div class="col-md-12">
							...
							<div class="widget">
								...
								<div class="widget-head">
									<div class="pull-left">试卷管理列表</div>
	...
	<script type="text/javascript">
		...
		function setDataRow(item) {
			...
			if(item.status == 0){
				statusCell.innerHTML = "<span class=\"label label-default\">禁用</span>"
			}else if(item.status == 1){
				statusCell.innerHTML = "<span class=\"label label-success\">启用</span>"
			}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'exampaper/page';
