...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<!-- Page heading -->
			<div class="page-head">
				<h2 class="pull-left">订单管理</h2>

				<!-- Breadcrumb -->
				<div class="bread-crumb pull-right">
					<a href="index.html"><i class="icon-home"></i> 主页</a>
					<!-- Divider -->
					<span class="divider">/</span> <a href="#" class="bread-current">订单</a>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="widget">
								...
								<div class="widget-head">
									<div class="pull-left">已发货订单列表</div>
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th onclick="sort('userid')">用户id<i id="useridIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('goodid')">商品id<i id="goodidIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('goodname')">商品名称<i id="goodnameIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('picture')">商品图片<i id="pictureIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('buynumber')">购买数量<i
													id="buynumberIcon" class="fa fa-sort"></i></th>
												<th onclick="sort('price')">价格/积分<i id="priceIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('discountprice')">折扣价格<i
													id="discountpriceIcon" class="fa fa-sort"></i></th>
												<th onclick="sort('total')">总价格/总积分<i id="totalIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('discounttotal')">折扣总价格<i
													id="discounttotalIcon" class="fa fa-sort"></i></th>
												<th onclick="sort('type')">支付类型<i
													id="typeIcon" class="fa fa-sort"></i></th>
												<th onclick="sort('status')">状态<i id="statusIcon"
													class="fa fa-sort"></i></th>
												<th onclick="sort('address')">地址<i id="addressIcon"
													class="fa fa-sort"></i></th>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item) {
			...
			shouhuoBtn.setAttribute('class', 'btn btn-xs btn-warning 修改');
			var shouhuoBtnAttri = 'shouhuo(' + item.id + ')';
			shouhuoBtn.setAttribute('onclick', shouhuoBtnAttri);
			var editIcon = document.createElement('i');
			editIcon.setAttribute('class', 'icon-edit');
			shouhuoBtn.appendChild(editIcon);
