...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<!-- Page heading -->
			<div class="page-head">
				<h2 class="pull-left">考试记录管理</h2>

				<!-- Breadcrumb -->
				<div class="bread-crumb pull-right">
					<a href="index.html"><i class="icon-home"></i> 主页</a>
					<!-- Divider -->
					<span class="divider">/</span> <a href="#" class="bread-current">考试记录</a>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="widget">
								...
								<div class="widget-head">
									<div class="pull-left">考试记录列表</div>
									<div class="widget-icons pull-right">									
										<form class="navbar-form navbar-left" id="searchForm"
											...
											<div class="form-group" id="form-item-group">
												<label>试卷</label> <input name="papername" placeholder="试卷名称">
												<label>试题名称</label> <input name="questionname"
													placeholder="试题名称">
											</div>
										</form>
	...
	<script type="text/javascript">
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'kaoshijilu/page';
